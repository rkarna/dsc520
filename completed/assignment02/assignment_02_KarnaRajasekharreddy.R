...
voter_turnout_df2 <- read_excel("data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 2, col_names = as.character(c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout")))
